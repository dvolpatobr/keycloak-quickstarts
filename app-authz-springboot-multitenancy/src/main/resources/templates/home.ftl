...
<header>
    ...
    <p><select onchange="document.location = '/' + this.value"><option>Change Tenant...</option><option value="realm-a">Tenant A</option><option value="realm-b">Tenant B</option></select></p>
     <p></p>
