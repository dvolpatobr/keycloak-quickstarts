...
public class KeycloakConfigResolver extends KeycloakSpringBootConfigResolver {
    ...
    private Map<String, KeycloakDeployment> tenants = new ConcurrentHashMap<String, KeycloakDeployment>();
    ...
    public KeycloakDeployment resolve(HttpFacade.Request request) {
        ...
        if (tenantIdx.length > 1) {
            return tenants.computeIfAbsent(tenantIdx[1], new Function<String, KeycloakDeployment>() {
